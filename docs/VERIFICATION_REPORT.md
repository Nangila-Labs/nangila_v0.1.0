...
| Script | Location |
| :--- | :--- |
| Gradient Match | `tests/phase1_truth/test_1_1_grads.py` |
| Overfitting Check | `tests/phase1_truth/test_1_2_overfit.py` |
| Sharding Verification | `tests/phase1_truth/test_1_3_sharding.py` |
| Throughput Benchmark | `tests/phase2_speed/test_2_1_throughput.py` |
